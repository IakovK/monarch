...
CpolygonsDoc::CpolygonsDoc() noexcept
{
...
void CpolygonsDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CpolygonsDoc::InitializeSearchContent()
{
...
void CpolygonsDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
