...
IMPLEMENT_DYNCREATE(CTextEditorDoc, CRichEditDoc)

BEGIN_MESSAGE_MAP(CTextEditorDoc, CRichEditDoc)
	// Enable default OLE container implementation
	ON_UPDATE_COMMAND_UI(ID_OLE_EDIT_LINKS, &CRichEditDoc::OnUpdateEditLinksMenu)
	ON_UPDATE_COMMAND_UI(ID_OLE_VERB_POPUP, &CTextEditorDoc::OnUpdateObjectVerbPopup)
...
CTextEditorDoc::CTextEditorDoc() noexcept
{
...
CRichEditCntrItem* CTextEditorDoc::CreateClientItem(REOBJECT* preo) const
{
	return new CTextEditorCntrItem(preo, const_cast<CTextEditorDoc*>(this));
}
